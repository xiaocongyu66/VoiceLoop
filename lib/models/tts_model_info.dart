...
class TtsModels {
  ...
  static List<TtsModelInfo> all() => [
    ...
    const TtsModelInfo(
      ...
      language: 'ja',
      sizeMb: 65,
      downloadUrl: '$_base/vits-piper-ja_JP-nozomi-medium.tar.bz2',
      modelFileName: 'ja_JP-nozomi-medium.onnx',
      tokensFileName: 'tokens.txt',
    ),
    const TtsModelInfo(
      id: 'piper-ko',
      ...
      language: 'ko',
      sizeMb: 65,
      downloadUrl: '$_base/vits-piper-ko_KR-glados-medium.tar.bz2',
      modelFileName: 'ko_KR-glados-medium.onnx',
      tokensFileName: 'tokens.txt',
    ),
    const TtsModelInfo(
      id: 'piper-fr',
      ...
      language: 'fr',
      sizeMb: 65,
      downloadUrl: '$_base/vits-piper-fr_FR-siwis-low.tar.bz2',
    ...
    const TtsModelInfo(
      ...
      language: 'de',
      sizeMb: 65,
      downloadUrl: '$_base/vits-piper-de_DE-thorsten-low.tar.bz2',
    ...
    const TtsModelInfo(
      ...
      language: 'es',
      sizeMb: 65,
      downloadUrl: '$_base/vits-piper-es_ES-carlfm-x_low.tar.bz2',
